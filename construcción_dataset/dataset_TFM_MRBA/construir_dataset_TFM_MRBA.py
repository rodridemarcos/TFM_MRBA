...
RUTAS_FUENTES = {
    "maestro": (
        "construcci%C3%B3n_dataset/dataset_maestro/"
        "dataset_maestro_vivienda_trimestral_2015_2024_IAV.csv"
    ),
    "adicional": "fuentes/Vivienda/fuentes_complementarias_provinciales.csv",
    "renta": "fuentes/Econom%C3%ADa/renta_provincia_anual.csv",
}
...
def leer_fuentes():
    ...
    renta = pd.read_csv(
        ruta("renta"), sep=None, engine="python", encoding="utf-8-sig",
    )
